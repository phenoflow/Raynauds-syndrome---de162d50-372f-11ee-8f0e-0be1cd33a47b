...
(async () => {
  ...
  await fs.writeFile("raynaud's-syndrome-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("raynaud's-syndrome-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
